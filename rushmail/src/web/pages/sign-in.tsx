        ...
        >
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12.5, color: "rgba(255,255,255,0.4)", margin: 0, lineHeight: 1.6 }}>
              ColdPulse sends tracked emails directly from your Gmail account — so replies land in your inbox and recipients see your real address.
            </p>
          </div>
          ...
          <p style={{
            ...
            By continuing, you allow ColdPulse to send emails on your behalf via Gmail.
          </p>
        </motion.div>
      </div>
